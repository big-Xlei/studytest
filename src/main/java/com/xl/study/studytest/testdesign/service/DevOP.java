package com.xl.study.studytest.testdesign.service;
...
public abstract class DevOP {
     ...
     * @return
     */
    public float getMemSize(String ip, String port, String rdCommunity) {
     ...
     * @return
     */
    public float getMemUseSize(String ip, String port, String rdCommunity) {
     ...
     * @return
     */
    public float getSwitchMemUseRatio(String ip, String port, String rdCommunity) {
        float result = 0;
        String memUseRatioOid = ".1.3.6.1.4.1.5651.3.20.1.1.1.9.0";
        Map<String, String> CPUMap = SnmpUtils.snmpWalk(ip, rdCommunity, port, memUseRatioOid);
     ...
     * @return
     */
    public Map<Integer, Long> getIfInOctets(String ip, String port, String rdCommunity) {
     ...
     * @return
     */
    public Long getIfInOctets(String ip, String port, String rdCommunity, Integer index) {
        String netInOctetsOid = ".1.3.6.1.2.1.2.2.1.10";
     ...
     * @return
     */
    public Map<Integer, Long> getIfOutOctets(String ip, String port, String rdCommunity) {
     ...
     * @return
     */
    public Long getIfOutOctets(String ip, String port, String rdCommunity, Integer index) {
     ...
     * @return
     */
    public Map<Integer, Long> getIfSpeed(String ip, String port, String rdCommunity) {
     ...
     * @return
     */
    public Long getIfSpeed(String ip, String port, String rdCommunity, Integer index) {
        String netSpeedOid = ".1.3.6.1.2.1.2.2.1.5";
